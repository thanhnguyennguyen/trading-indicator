...
const main = async () => {
  try {
    ...
    console.log(
      await module.exports.rsi(14, "close", "binance", "BTC/USDT", "15m", true),
    );
    ...
    let macdData = await module.exports.macd(
      12,
      26,
      9,
      "close",
    ...
    console.log(
      await module.exports.stochasticrsi(
        3,
        3,
        14,
        14,
    ...
    console.log(
      await module.exports.ichimokuCloud(9, 26, 52, 26, "binance", "BTC/USDT", "1h", false),
    );

    console.log("Test golden cross");
    console.log(
      await module.exports.goldenCross(50, 200, "binance", "BTC/USDT", "1h", false),
    );

    console.log("Test MA cross");
    console.log(
      await module.exports.maCross(50, 200, "binance", "BTC/USDT", "1h", false),
    );

    console.log("Test RSIcheck");
    console.log(
      await module.exports.rsiCheck(14, 75, 25, "binance", "BTC/USDT", "1h", false),
    );

    console.log("Test SMA cross");
    console.log(
      await module.exports.priceCrossSMA(14, "binance", "BTC/USDT", "1h", false),
    );

    console.log("Test EMA cross");
    console.log(
      await module.exports.priceCrossEMA(14, "binance", "BTC/USDT", "1h", false),
    );

    console.log("Test break out BB");
    console.log(
      await module.exports.bbCheck(50, 2, "binance", "BTC/USDT", "1h", false),
    );
  } catch (err) {
    console.log(err);
  }
